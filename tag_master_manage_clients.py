"""
One-time script: tag 169 clients as "Master Manage" and backfill their transactions.
If a client email is not found in the DB, a new client record is created
with the Master Manage tag already applied.
